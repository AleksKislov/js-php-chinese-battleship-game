...
var view = {
    ...
    colors: ["комфортный","красивый","недорогой","известный","важный","интересный","нехороший","дешевый","тихий","крупный"],

    colorsObject: [
                   { chineseAdjectives: ["舒适","好看","不贵","有名","重要","有意思","不好","便宜","安静","大型"],
                     rusAdjectives: ["комфортный","красивый","недорогой","известный","важный","интересный","нехороший","дешевый","тихий","крупный"],
                     pinyinAdjectives: ["shūshì", "hǎokàn", "bú guì","yǒumíng","zhòngyào","yǒuyìsi","bù hǎo","piányi","ānjìng","dàxíng"]}
                    ],   
