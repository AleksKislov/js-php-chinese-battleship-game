		...
		<div class="col-sm-4">
			...
			<div id="emoticons">
			 ...
			 <div id="reminderButtonDiv"><h6>Подсказки</h6>
				<button type="button" class="btn btn-outline-primary btn-sm" id="reminderButton">Объекты</button><button type="button" class="btn btn-outline-primary btn-sm" id="reminderButtonColors">Локации</button></div>
		...
		<div class="col-sm-8">
            ...
            <div class="collapse" id="collapse0">
					<div class="alert alert-success" role="alert">
						<p>Для выбора клетки нужно ввести ответ на вопрос {объект}在哪里 или 哪里有{объект}, то есть фразы типа "大象在桌子上面" или "盒子里面有猫".</p>
						<p>ВНИМАНИЕ: используйте двусложные послелоги, например, 上面 или 里面, но не односложные, типа 上 или 里.</p>
