		...
		<div class="col-sm-4">
			...
			<div id="emoAndShips">
			 ...
			 <div id="reminderButtonDiv"><h6>Hints</h6>
				<button type="button" class="btn btn-outline-primary btn-sm" id="reminderButton">Nouns</button><button type="button" class="btn btn-outline-primary btn-sm" id="reminderButtonColors">Adjectives</button></div>
		...
		<div class="col-sm-8">
            ...
            <div class="collapse" id="collapse0">
                <div class="alert alert-success" role="alert">
                    <p>In order to choose a cell you need to input phrases like "adjective + 的 + noun", for instance 不好的大学.</p>
