...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-8 comments">
			<h3 style="margin-bottom: 1rem">Comments 
				<button type="button" class="btn btn-outline-secondary btn-sm" id="commentsToggle">Toggle</button>
				<a href="<?php echo $ROOT_URL . 'php/eng/inc/add-comment.php' ?>" class="btn btn-outline-primary btn-sm">Add a Comment</a>
			</h3>
			...
			<div id="allComments">
				<?php foreach($comments as $comment) : ?>
					...
					<div class="card bg-light mb-3">
						<div class="card-header"><?php echo $comment['author']; ?> <?php echo $comment['date'] ?> said:</div>
						<div class="card-body">
