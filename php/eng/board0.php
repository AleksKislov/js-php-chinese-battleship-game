			...
			<div class="console" id="messageArea">console</div>
				...
				<div id="emoticons">
			 	...
			 	<div id="reminderButtonDiv"><h6>Hints</h6>
					<button type="button" class="btn btn-outline-primary btn-sm" id="reminderButton">Animals</button><button type="button" class="btn btn-outline-primary btn-sm" id="reminderButtonColors">Colors</button></div>
				...
				<div id="centerIt">
						<form id="searchBox" method="get" action="index.html" class="form-inline">
								...
								<div class="speech">
										...
										<img onclick="startDictation();" src="microphone.png" id="imgSpeech" data-toggle="tooltip" data-placement="bottom" data-original-title="Speak!" />
								</div>
						</form>
				</div>
		</div>
		...
		<div class="col-sm-8">
			...
			<div id="tableBoard">
				...
				<table class="table"> 
					...
					<tr>
						...
						<th id="01" style="text-align:center">1</th>
						<th id="02" style="text-align:center">2</th>
						<th id="03" style="text-align:center">3</th>
						<th id="04" style="text-align:center">4</th>
						<th id="05" style="text-align:center">5</th>
						<th id="06" style="text-align:center">6</th>
						<th id="07" style="text-align:center">7</th>
						<th id="08" style="text-align:center">8</th>
						<th id="09" style="text-align:center">9</th>
					</tr>
					<tr>
						<th id="10"></th>
						<td id="11"></td>
            ...
            <div class="collapse" id="collapse0">
					<div class="alert alert-success" role="alert">
						<p>In order to choose a cell you need to input 4-5 Chinese characters, e.g. phrases like "红色的大象" or "灰色的猫", but not “白兔” nor “黑马” would do.</p>
