<div class="row">
		<div class="col-sm-4">
			...
			<div id="emoAndShips">
			 ...
			 <div id="reminderButtonDiv"><h6>Hints</h6>
				<button type="button" class="btn btn-outline-primary btn-sm" id="reminderButton">Objects</button><button type="button" class="btn btn-outline-primary btn-sm" id="reminderButtonColors">Numbers</button></div>
		...
		<div class="col-sm-8">
			...
			<div class="collapse" id="collapse1">
					<div class="card">
						<div class="card-body" id="allThings">
						</div>
					</div>
			</div>
            ...
            <div class="collapse" id="collapse0">
                <div class="alert alert-success" role="alert">
                    	<p>In order to choose a cell you need to input phrases like "number + measure word + noun", e.g. 两只鸟.</p>
