		...
		<div class="col-sm-4">
			...
			<div id="emoAndShips">
			 ...
			 <div id="reminderButtonDiv"><h6>Подсказки</h6>
				<button type="button" class="btn btn-outline-primary btn-sm" id="reminderButton">Объекты</button><button type="button" class="btn btn-outline-primary btn-sm" id="reminderButtonColors">Числа</button></div>
		...
		<div class="col-sm-8">
            ...
            <div class="collapse" id="collapse0">
                <div class="alert alert-success" role="alert">
                    <p>Для выбора клетки нужно ввести словосочетания типа "числительное + счетное слово + существительное", например, 两只鸟.</p>
