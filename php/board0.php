			...
			<div class="console" id="messageArea">консоль</div>
				...
				<div id="emoticons">
			 	...
			 	<div id="reminderButtonDiv"><h6>Подсказки</h6>
					<button type="button" class="btn btn-outline-primary btn-sm" id="reminderButton">Животные</button><button type="button" class="btn btn-outline-primary btn-sm" id="reminderButtonColors">Цвета</button></div>
		...
		<div class="col-sm-8">
            ...
            <div class="collapse" id="collapse0">
					<div class="alert alert-success" role="alert">
						<p>Для выбора клетки нужно ввести 4-5 иероглифов, то есть фразы типа "红色的大象" или "灰色的猫", но не “白兔” или “黑马”.</p>
