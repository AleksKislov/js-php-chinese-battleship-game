...
var view = {
    ...
    colors: ["comfortable","good-looking","inexpensive","famous","important","interesting","not good","cheap","quiet","large-scale", "dangerous"],

    colorsObject: [
                   { chineseAdjectives: ["舒适","好看","不贵","有名","重要","有意思","不好","便宜","安静","大型", "危险"],
                     rusAdjectives: ["comfortable","good-looking","inexpensive","famous","important","interesting","not good","cheap","quiet","large-scale", "dangerous"],
    ...
    animalsObject: [
                    { chineseThings: ["地方", "地铁", "饭店", "食堂", "学院", "图书馆", "博物馆", "火车站", "大学", "体育馆", "厨房", "咖啡馆", "商店", "医院", "剧院", "机场"],
                      rusNouns: ["place", "subway", "restaurant", "canteen", "institute", "library", "museum", "railway station", "university", "gymnasium", "kitchen", "coffee shop", "shop", "hospital", "theater", "airport"],
    ...
    animals: ["place", "subway", "restaurant", "canteen", "institute", "library", "museum", "railway station", "university", "gymnasium", "kitchen", "coffee shop", "shop", "hospital", "theater", "airport"],
