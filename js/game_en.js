...
var view = {
    ...
    animalsObject: [
                    { chineseAnimals: ["猫", "大象", "鱼", "青蛙", "鸡", "马", "狮子", "猴子", "熊猫", "猪", "乌龟", "兔子", "狗", "牛", "鸭子", "羊", "蛇"],
                      englishAnimals: ["cat", "elephant", "fish", "frog", "hen", "horse", "lion", "monkey", "panda", "pig", "turtle", "rabbit", "dog", "cow", "duck", "sheep", "snake"],
                      pinyinAnimals: ["māo", "dàxiàng", "yú", "qīngwā", "jī", "mǎ", "shīzi", "hóuzi", "xióngmāo", "zhū", "wūguī", "tùzi", "gǒu", "niú", "yāzi", "yáng", "shé"]}
                    ],
    ...
    displayReminder: function() {
        ...
        for (var i=0; i< 9; i++) {
            ...
            elem.src = "img/1level/" + this.animalsObject[0].englishAnimals[index] + ".png";
    ...
    displayAllAnimals: function() {
        ...
        for (let i=0; i < this.animals.length; i++) {
            ...
            elem.src = "img/1level/" + this.animalsObject[0].englishAnimals[i] + ".png";
            elem.style.height = "48px";
    ...
    animals: ["猫", "大象", "鱼", "青蛙", "鸡", "马", "狮子", "猴子", "熊猫", "猪", "乌龟", "兔子", "狗", "牛", "鸭子", "羊", "蛇"],
