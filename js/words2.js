...
var view = {
    ...
    colors: ["знаменитый","скучный","богатый","лучший","надежный","скромный","стеснительный","болтливый","одинокий","крепкий", "хитрый"],

    colorsObject: [
                   { chineseAdjectives: ["著名","无聊","有钱","最好","靠谱","谦虚","害羞","啰嗦","孤独","强壮", "狡猾"],
                     rusAdjectives: ["знаменитый","скучный","богатый","лучший","надежный","скромный","стеснительный","болтливый","одинокий","крепкий", "хитрый"],
    ...
    animalsObject: [
                    { chineseThings: ["教师", "教授", "音乐家", "部长", "哲学家", "会计", "导演", "司机", "医生", "运动员", "科学家", "工程师", "总统", "演员", "作家", "画家"],
                        rusNouns: ["преподаватель", "профессор", "музыкант", "министр", "философ", "бухгалтер", "режиссер", "водитель", "доктор", "спортсмен", "ученый", "инженер", "президент", "актер", "писатель", "художник"],
    ...
    animals: ["преподаватель", "профессор", "музыкант", "министр", "философ", "бухгалтер", "режиссер", "водитель", "доктор", "спортсмен", "ученый", "инженер", "президент", "актер", "писатель", "художник"],
