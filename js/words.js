...
var view = {
    ...
    colors: ["комфортный","красивый","недорогой","известный","важный","интересный","нехороший","дешевый","тихий","крупный", "опасный"],

    colorsObject: [
                   { chineseAdjectives: ["舒适","好看","不贵","有名","重要","有意思","不好","便宜","安静","大型", "危险"],
                     rusAdjectives: ["комфортный","красивый","недорогой","известный","важный","интересный","нехороший","дешевый","тихий","крупный", "опасный"],
                     pinyinAdjectives: ["shūshì", "hǎokàn", "bú guì","yǒumíng","zhòngyào","yǒuyìsi","bù hǎo","piányi","ānjìng","dàxíng", "wēixiǎn"]}
                    ],   

    animalsObject: [
                    { chineseThings: ["地方", "地铁", "饭店", "食堂", "学院", "图书馆", "博物馆", "火车站", "大学", "体育馆", "厨房", "咖啡馆", "商店", "医院", "剧院", "机场"],
                      rusNouns: ["место", "метро", "ресторан", "столовая", "институт", "библиотека", "музей", "вокзал", "университет", "спортзал", "кухня", "кофейня", "магазин", "больница", "театр", "аэропорт"],
                      pinyinThings: ["dìfang", "dìtiě", "fàndiàn", "shítáng", "xuéyuàn", "túshūguǎn", "bówùguǎn", "huǒchēzhàn", "dàxué", "tǐyùguǎn", "chúfáng", "kāfēiguǎn", "shāngdiàn", "yīyuàn", "jùyuàn", "jīchǎng"]}
                    ],

    animals: ["место", "метро", "ресторан", "столовая", "институт", "библиотека", "музей", "вокзал", "университет", "спортзал", "кухня", "кофейня", "магазин", "больница", "театр", "аэропорт"],
...
function parseGuess(guess) {
    ...
    if (guess === null || guess.length > 7) {
        ...
        alert("Фраза состоит из 4-7 иероглифов!");
    } else {
        ...
        if (guess.indexOf("的") > 0) {
            ...
            alert("Фраза должна содержать частицу 的!");
        }
