...
var view = {
    ...
    animalsObject: [
                    { chineseAnimals: ["蚂蚁", "老鹰", "蝈蝈", "蚊子","毛毛虫","鳗鱼","水母","犀牛","鳄鱼","苍蝇","瓢虫","蝎子","恐龙","山羊","蜥蜴","蜘蛛", "狼"],
                      englishAnimals: ["ant","eagle","grasshopper","mosquito","caterpillar","eel","jellyfish","rhino","crocodile","fly","ladybug","scorpion","dinosaur","goat","lizard","spider", "wolf"],
                      pinyinAnimals: ["mǎyǐ", "lǎoyīng", "guōguo", "wénzi","máomáochóng","mányú","shuǐmǔ","xīniú","èyú","cāngying","piáochóng","xiēzi","kǒnglóng","shānyáng","xīyì","zhīzhū", "láng"]}
                    ],
    ...
    displayReminder: function() {
        ...
        for (var i=0; i< 9; i++) {
            ...
            elem.src = "img/4level/" + this.animalsObject[0].englishAnimals[index] + ".png";
    ...
    displayAllAnimals: function() {
        ...
        for (let i=0; i < this.animals.length; i++) {
            ...
            elem.src = "img/4level/" + this.animalsObject[0].englishAnimals[i] + ".png";
            elem.style.height = "48px";
    ...
    animals: ["蚂蚁", "老鹰", "蝈蝈", "蚊子","毛毛虫","鳗鱼","水母","犀牛","鳄鱼","苍蝇","瓢虫","蝎子","恐龙","山羊","蜥蜴","蜘蛛","狼"],
