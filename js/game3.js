...
var view = {
    ...
    animalsObject: [
                    { chineseAnimals: ["驼羊", "龙", "鸵鸟", "海马", "斑马", "蝴蝶", "火烈鸟", "猫头鹰", "海狮", "骆驼", "河马", "鹦鹉", "天鹅", "变色龙", "树袋熊", "企鹅", "海象"],
                      englishAnimals: ["alpaca","dragon","ostrich","sea_horse","zebra","butterfly","flamingo","owl","sea_lion","camel","hippo","parrot","swan","chameleon","koala","penguin","walrus"],
                      pinyinAnimals: ["tuóyáng", "lóng", "tuóniǎo", "hǎimǎ", "bānmǎ", "húdié", "huǒlièniǎo", "māotóuyīng", "hǎishī", "luòtuo", "hémǎ", "yīngwǔ", "tiān é", "biànsèlóng", "shùdàixióng", "qǐ é", "hǎixiàng"]}
                    ],
    ...
    displayReminder: function() {
        ...
        for (var i=0; i< 9; i++) {
            ...
            elem.src = "img/3level/" + this.animalsObject[0].englishAnimals[index] + ".png";
    ...
    displayAllAnimals: function() {
        ...
        for (let i=0; i < this.animals.length; i++) {
            ...
            elem.src = "img/3level/" + this.animalsObject[0].englishAnimals[i] + ".png";
            elem.style.height = "48px";
    ...
    animals: ["驼羊", "龙", "鸵鸟", "海马", "斑马", "蝴蝶", "火烈鸟", "猫头鹰", "海狮", "骆驼", "河马", "鹦鹉", "天鹅", "变色龙", "树袋熊", "企鹅", "海象"],
